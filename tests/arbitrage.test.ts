...
describe.skip("Pool Arbitrage Protection", () => {
    describe("2.0 Basic Arbitrage Resistance", () => {
    ...
    describe("2.1 Single-Sided Liquidity Protection", () => {
    ...
    describe("2.2 Multi-Cycle Trading Protection", () => {
        const ATTEMPT_AMOUNT = 1_000 * Simulator.getUnit();    // 1k tokens
        const MAX_ACCEPTABLE_PROFIT = 0.001;    // 0.1% maximum acceptable profit
    ...
    describe("2.3 External Market Protection", () => {
        const ATTEMPT_AMOUNT = 1_000 * Simulator.getUnit();    // 1k tokens
        const MAX_ACCEPTABLE_PROFIT = 0.001;    // 0.1% maximum acceptable profit
