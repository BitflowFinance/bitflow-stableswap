...
(define-constant ERR_ALREADY_ADMIN (err u2003))
(define-constant ERR_ADMIN_LIMIT_REACHED (err u2004))
(define-constant ERR_ADMIN_NOT_IN_LIST (err u2005))
(define-constant ERR_CANNOT_REMOVE_CONTRACT_DEPLOYER (err u2006))
