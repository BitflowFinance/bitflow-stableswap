...
(define-constant ERR_ALREADY_ADMIN (err u4003))
(define-constant ERR_ADMIN_LIMIT_REACHED (err u4004))
(define-constant ERR_ADMIN_NOT_IN_LIST (err u4005))
(define-constant ERR_CANNOT_REMOVE_CONTRACT_DEPLOYER (err u4006))
(define-constant ERR_STAKING_DISABLED (err u4007))
(define-constant ERR_EARLY_UNSTAKE_DISABLED (err u4008))
(define-constant ERR_TOKEN_TRANSFER_FAILED (err u4009))
(define-constant ERR_INVALID_CYCLE_LENGTH (err u4010))
(define-constant ERR_CYCLES_STAKED_OVERFLOW (err u4011))
