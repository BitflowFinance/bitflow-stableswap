...
(define-constant ERR_MATCHING_TOKEN_CONTRACTS (err u3009))
(define-constant ERR_INVALID_X_TOKEN (err u3010))
(define-constant ERR_INVALID_Y_TOKEN (err u3011))
(define-constant ERR_MINIMUM_X_AMOUNT (err u3012))
(define-constant ERR_MINIMUM_Y_AMOUNT (err u3013))
(define-constant ERR_MINIMUM_LP_AMOUNT (err u3014))
(define-constant ERR_UNEQUAL_POOL_BALANCES (err u3015))
(define-constant ERR_MINIMUM_D_VALUE (err u3016))
(define-constant ERR_INVALID_FEE (err u3017))
(define-constant ERR_MINIMUM_BURN_AMOUNT (err u3018))
